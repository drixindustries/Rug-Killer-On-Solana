...
[GMGN](https://gmgn.ai/sol/token/${analysis.tokenAddress}) • [Birdeye](https://birdeye.so/token/${analysis.tokenAddress}?chain=solana) • [Axiom](https://axiom.trade/sol/token/${analysis.tokenAddress}) • [Padre](https://t.me/padre_tg_bot?start=${analysis.tokenAddress})`;
