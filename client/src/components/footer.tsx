        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><a href="https://github.com/drixindustries/rugkilleronsol#roadmap" target="_blank" rel="noopener noreferrer" className="hover:text-foreground" data-testid="footer-link-roadmap">Roadmap</a></li>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex gap-2">
                ...
                >
                  <a href="https://github.com/drixindustries/rugkilleronsol" target="_blank" rel="noopener noreferrer" title="GitHub" aria-label="View on GitHub">
